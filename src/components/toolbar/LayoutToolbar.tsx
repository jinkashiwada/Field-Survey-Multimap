...
export function LayoutToolbar({ activeLayout, viewport, onChange, onPreset, onLocate, locationLoading, onAddPin, onImport, onExportKml, onExportGeoJson, onShare, onSettings }: LayoutToolbarProps) {
